...
<br>
 ...
 {{csrf_field()}}
 <h3 style="color:white; ">Report ID<select    name="report" style="margin-left:140px; color:white;" class="effect" ></h3>
...
<h3 style="color:white;">Name:<input class="effect" type="text" name="name" style="margin-left:150px" ><br></h3>
<br><br>
